...
- **`historical`** - A read-only preservation of the original reverse-engineered code, maintained for historical accuracy
- **`main`** - Active development branch with modern enhancements and new features
